# Graph Report - thewordof-tools  (2026-05-24)

## Corpus Check
- 221 files · ~132,200 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1599 nodes · 2417 edges · 135 communities (112 shown, 23 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6f4e0c0c`
...
1. `cn()` - 138 edges
2. `Button()` - 39 edges
3. `CardContent()` - 37 edges
4. `Card()` - 36 edges
5. `CardHeader()` - 34 edges
6. `CardTitle()` - 31 edges
...
Cohesion: 0.1
Nodes (15): LogoutButton(), ThemeToggle(), DashboardNav(), navItems, DashboardShell(), Footer(), Header(), PageTransition() (+7 more)
...
Cohesion: 0.05
Nodes (83): metadata, calculators, metadata, SettingsForm(), SettingsFormProps, metadata, useUsageLimit(), metadata (+75 more)

### Community 13 - "Community 13"
Cohesion: 0.14
Nodes (7): metadata, metadata, generateSeoMetadata(), SeoMetadataInput, metadata, metadata, metadata
...
Cohesion: 0.06
Nodes (5): metadata, metadata, metadata, metadata, { handlers, auth, signIn, signOut }
...
Cohesion: 0.12
Nodes (16): Avoid assuming tools are installed, code:block52, code:block53, code:`markdown (## Form layout analysis), code:block55, code:block56 (bigquery-skill/), code:markdown (Use the BigQuery:bigquery_schema tool to retrieve table sche), code:`markdown (**Bad example: Assumes installation**:) (+8 more)
...
Cohesion: 0.08
Nodes (35): BillingPage(), cn(), NativeToggle(), NativeToggle(), NativeToggle(), NativeToggle(), NativeToggle(), Accordion() (+27 more)
...
## Knowledge Gaps
- **795 isolated node(s):** `version`, `source`, `sourceType`, `skillPath`, `computedHash` (+790 more)
...
- **Why does `cn()` connect `Community 45` to `Community 0`, `Community 1`, `Community 7`, `Community 10`, `Community 107`, `Community 12`, `Community 54`, `Community 55`, `Community 90`, `Community 91`?**
