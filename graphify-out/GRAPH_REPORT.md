# Graph Report - thewordof-tools  (2026-05-30)

## Corpus Check
- 258 files · ~155,439 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1879 nodes · 2785 edges · 166 communities (145 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d5560787`
...
Cohesion: 0.21
Nodes (8): SUBSCRIPTION_PLANS, POST(), createPayPalSubscription(), razorpay, getPlanDetailsByPlanId(), POST(), getRazorpayPlanDetails(), POST()
...
Cohesion: 0.22
Nodes (9): POST(), POST(), POST(), POST(), POST(), verifyAndDeductCredits(), POST(), POST() (+1 more)
...
Cohesion: 0.08
Nodes (41): CreditOverview(), SupportModalProps, cn(), UpgradeButtonProps, Window, NativeToggle(), Accordion(), AccordionContent() (+33 more)
...
Cohesion: 0.12
Nodes (17): FormData, loginSchema, registerSchema, UserAuthForm(), UserAuthFormProps, BillingPage(), LoginPage(), metadata (+9 more)
...
Cohesion: 0.16
Nodes (17): metadata, CreditOverviewProps, SettingsForm(), SettingsFormProps, metadata, PRESETS, COLORS, ProductDescriptionProps (+9 more)
...
Cohesion: 0.1
Nodes (14): ColorConverter(), ColorConverterProps, COLORS, QRCodeGenerator(), QRCodeProps, QrItem, QrStats, DURATION_PRESETS (+6 more)
...
Cohesion: 0.27
Nodes (10): POST(), POST(), POST(), sendPaymentFailedEmail(), sendPaymentSuccessEmail(), cancelPayPalSubscription(), capturePayPalOrder(), createPayPalOrder() (+2 more)
...
Cohesion: 0.05
Nodes (30): LogoutButton(), ThemeToggle(), DashboardNav(), navItems, DashboardShell(), Footer(), Header(), MobileNav() (+22 more)
...
Cohesion: 0.06
Nodes (8): metadata, metadata, metadata, metadata, metadata, metadata, { handlers, auth, signIn, signOut }, SchemaGenerator()

### Community 131 - "Community 131"
Cohesion: 0.13
Nodes (25): useUsageLimit(), getDailyUsage(), getMonthlyUsage(), incrementDailyUsage(), incrementMonthlyUsage(), isLimitReached(), UsageData, CaptionGenerator() (+17 more)

### Community 132 - "Community 132"
Cohesion: 0.21
Nodes (7): GSTCalculator(), GSTCalculatorProps, NativeToggle(), Rate, NativeToggle(), Checkbox, Switch
...
Cohesion: 0.22
Nodes (12): calculators, metadata, EmiCalculator(), SipCalculator(), NativeToggle(), SVGFile, CardDescription(), Tabs() (+4 more)
...
## Knowledge Gaps
- **941 isolated node(s):** `version`, `source`, `sourceType`, `skillPath`, `computedHash` (+936 more)
...
- **Why does `cn()` connect `Community 45` to `Community 160`, `Community 161`, `Community 0`, `Community 131`, `Community 132`, `Community 7`, `Community 137`, `Community 107`, `Community 12`, `Community 141`, `Community 55`, `Community 90`, `Community 92`?**
