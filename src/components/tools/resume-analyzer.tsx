      ...
      <div className="space-y-6">
        <Card className="border-primary/10">
          <CardHeader>
            ...
            <CardDescription>Paste your resume text below to get detailed AI feedback.</CardDescription>
          </CardHeader>
          <CardContent>
            {!isLoggedIn ? (
              ...
              <form onSubmit={handleGenerate} className="space-y-4">
                ...
                <Button type="submit" className="w-full h-12 gap-2 mt-4 font-bold rounded-xl shadow-lg shadow-primary/20" disabled={isLoading || limitReached || !text}>
                  {isLoading ? (
      ...
      <div className="space-y-6">
        <Card className="h-full border-primary/10 flex flex-col relative overflow-hidden bg-muted/20">
          <CardHeader>
            ...
            <CardDescription className="text-xs">Strengths, action verbs, and improvements</CardDescription>
          </CardHeader>
