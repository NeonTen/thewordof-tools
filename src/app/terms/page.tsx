        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              By accessing and using TheWordOf Tools ("the Service"), you agree
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              TheWordOf Tools provides various online utility tools, including
              image converters, SVG compressors, AI-powered content generators,
              and financial calculators. These tools are provided "as is" and
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              prohibited from using the Service to process, generate, or
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              data) are and will remain the exclusive property of TheWordOf. Our
              trademarks and trade dress may not be used in connection with any
              product or service without the prior written consent of TheWordOf.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              In no event shall TheWordOf be liable for any indirect,
