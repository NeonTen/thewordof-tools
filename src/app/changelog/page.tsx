        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto leading-relaxed">
              Explore the timeline of new additions, bug fixes, performance
                  ...
                  <div className="bg-card border rounded-[2rem] p-6 md:p-8 shadow-sm hover:shadow-md hover:border-border/80 transition-all duration-300 space-y-8">
                    {release.sections.map((section, sIdx) => {
                      ...
                      return (
                        <div
                          key={sIdx}
                          className="space-y-4 last:mb-0 border-b border-border/40 last:border-none pb-6 last:pb-0"
                        >
                          {/* Badge tag */}
                          <span
                            className={`inline-flex items-center gap-1.5 border px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest ${style.color}`}
                          >
