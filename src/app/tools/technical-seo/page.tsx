...
import { Code, FileText, Layers, Cpu, Search, Type, Zap } from "lucide-react";
...
const tools = [
  {
    ...
    description:
      "Build JSON-LD structured data for Google Rich Results with live search previews.",
  ...
  },
  {
    ...
    description:
      "Configure robots.txt crawler directives and test path access rules locally.",
  ...
  },
  {
    ...
    description:
      "Fetch, validate, audit, and visually map XML Sitemap hierarchical structures.",
  ...
  },
  {
    ...
    description:
      "Generate AI-readable site summaries and specifications for LLM web crawlers.",
  ...
  },
  {
    ...
    description:
      "Preview search results snippet presentation on Google Search, compute title/description sizing, and generate standard SEO and Open Graph tags.",
  ...
  },
  {
    ...
    description:
      "Extract text directly from URL imports or raw text blocks to calculate word frequency and search optimization ratios.",
  ...
  },
  {
    ...
    description:
      "Grade standard content readability scores using linguistic formulas including Flesch Reading Ease calculations.",
  ...
  },
  {
    ...
    description:
      "Inspect external websites to identify broken links, redirects, internal vs external ratios, and anchor texts.",
    ...
    <div className="flex flex-col gap-8 pb-16">
      <div>
        ...
        <p className="text-muted-foreground mt-2 text-base">
          Audit website indexing signals, generate structured metadata, and
          optimize for both search engine crawlers and LLM bots.
        </p>
      </div>
