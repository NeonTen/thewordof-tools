...
const calculators = [
  {
    ...
    description:
      "Calculate your monthly EMI payments for home, car, or personal loans.",
  ...
  },
  {
    ...
    description:
      "Calculate compound interest returns with annual inflation adjustments.",
  ...
  },
  {
    ...
    description:
      "Convert annual/monthly salary to hourly rates, daily rates, and vice-versa.",
  ...
  },
  {
    ...
    description:
      "Compute dimension resizes and aspect ratios for layouts and images.",
  ...
  },
  {
    ...
    description:
      "Convert line-height pixels, rems, or percentages into relative CSS values.",
  ...
  },
  {
    ...
    description:
      "Convert pixels to REM units bidirectionally with a Tailwind CSS utility lookup sheet.",
    ...
    <div className="flex flex-col gap-8 pb-16">
      <div>
        ...
        <p className="text-muted-foreground mt-2 text-base">
          A premium suite of tools for finance planning, design utilities, and
          health tracking.
        </p>
      </div>
