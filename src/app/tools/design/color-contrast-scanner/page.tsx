...
export const metadata = {
  ...
  description: "Scan any webpage URL for contrast accessibility. Find elements failing WCAG AA & AAA standards with detailed selector reports.",
}
...
export default async function ColorContrastScannerPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      <div>
        <ToolHeader category="Design" categoryHref="/tools/design" title="Color Contrast Scanner" />
        <p className="text-muted-foreground mt-2">
          Scan any webpage URL to find elements that fail WCAG readability contrast guidelines.
        </p>
      </div>
