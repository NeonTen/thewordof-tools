...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/tools/invoice-generator", destination: "/tools/finance-dev/invoice-generator", permanent: true },
      { source: "/tools/report", destination: "/tools/finance-dev/report", permanent: true },
